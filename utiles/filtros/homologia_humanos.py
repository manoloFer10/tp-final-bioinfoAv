...
def filtrar_homologia_humanos(proteinas: list[str]):
...
def procesar_homologia_humanos(df):
    ...
    """
    df = df[df['ID'].isin(filtrar_homologia_humanos(df['ID'].tolist()))] #esto puede ser en la columna ID o en la que necesiten!
    return df
...
if __name__ == "__main__":
    ...
    # se llama así: python filtros/homologia_humanos.py --archivo_testeo proteinas_a_testear.csv
